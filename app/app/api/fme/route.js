...
export async function POST(req) {
  ...
  // após baixar o estoque, avisa se algum artigo cruzou o estoque mínimo
  for (const p of prep) await checarEstoqueMinimo(prisma, p.art.id, responsavelEstoque).catch(() => {});
