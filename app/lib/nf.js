...
export function parseXmlNfe(xml) {
  ...
  return {
    ...
    emit: {
      ...
      inscricaoEstadual: emit.IE ? String(emit.IE) : null,
      logradouro: emit.enderEmit?.xLgr || null,
      numero: emit.enderEmit?.nro != null ? String(emit.enderEmit.nro) : null,
      ...
      cep: emit.enderEmit?.CEP ? String(emit.enderEmit.CEP).replace(/\D/g, "") : null,
      telefones: emit.enderEmit?.fone ? String(emit.enderEmit.fone) : null,
    },
    itens,
  };
}
